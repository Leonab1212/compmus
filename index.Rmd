...
### Conclusion
My very first hypothesis that it was tempo, that dictated the title, was quickly wiped of the table. So what made the recordings distinguishable for the classifier? I think the answer lies in imporovisation. From what we can see from the self simmilarity matrices, the OTHGY recording tends to be a more complicated improvisation all thoughout the recording. HHTM has a clearer structure in the improvisation. Another strong factor for why our classifier is able to distinguish the recordings, is that what we can see in the previous scatterplot of energy vs valence. Combining those two factors I believe would already give us quite a good way to classify what recording goes with what title.  
